...
- Third-person player and camera foundations
- Keyboard, mouse and controller input abstraction
- Scene and UI boundaries suitable for an MMORPG client
...
Ce dépôt reste exclusivement documentaire. Le futur template 3D classique devra être extrait de façon isolée et originale, après validation des droits et du contrat avec le serveur canonique.
