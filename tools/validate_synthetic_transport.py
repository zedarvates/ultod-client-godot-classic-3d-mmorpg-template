...
"""Execute the deterministic Godot transport fixture with Godot 4.7.2.

This is synthetic fixture evidence only. It never proves compatibility with the
private canonical Zig server.
"""
...
def main() -> int:
    ...
    parser.add_argument("--evidence", default=".evidence/godot-synthetic-transport.json")
    ...
    report: dict[str, Any] = {
        "schema": "uo.godot-synthetic-transport-run/v1",
    ...
    if not passed:
        report["failure"] = "Fixture did not return a valid synthetic-only success receipt"
